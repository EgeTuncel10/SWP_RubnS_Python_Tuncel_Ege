...
def straight_flush(hand):
    if flush(hand):
        # from here to
        # this is the same code like in straight() but removed check if 5 and 10 in straight,
        #       cause in wikipedia it says that in a straight it should hava a 5 and 10,
        #       but it says nothing for the straight flush
